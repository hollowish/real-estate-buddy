  ...
  return (
    <main style={S.page}>
      ...
      <section style={{
        ...
        {/* Image upload zone — top-right corner */}
        ...
        <div style={S.heroContent}>
          ...
          <div style={S.heroCtas}>
            <Link to="/listings" className="btn-primary btn-pill btn-lg" style={S.ctaPrimary}>
              View Listings
            </Link>
            <Link to="/signup" className="btn-secondary btn-pill btn-lg" style={S.ctaSecondary}>
              Get Started Free
            </Link>
          </div>
        </div>
